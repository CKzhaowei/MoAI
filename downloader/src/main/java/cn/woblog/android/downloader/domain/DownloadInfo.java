...
public class DownloadInfo implements Serializable {
  ...
  private List<DownloadThreadInfo> downloadThreadInfos;
    ...
    private boolean isSelected = false;//??checkbox
    ...
    private String downloadTrackName;

    public String getDownloadTrackName() {
        return downloadTrackName;
    }

    public void setDownloadTrackName(String downloadTrackName) {
        this.downloadTrackName = downloadTrackName;
    }
